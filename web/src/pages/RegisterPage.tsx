...
export default function RegisterPage() {
  ...
  const formContent = (
    <>
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <Input label="Full Name" type="text" placeholder="Your full name" value={displayName} onChange={(e) => setDisplayName(e.target.value)} required />
        ...
        <Input label="Confirm Password" type="password" placeholder="Re-enter your password" value={confirm} onChange={(e) => setConfirm(e.target.value)} required />
  ...
  return (
    ...
    >
      {/* ── Mobile: hero header ── */}
      <div className="md:hidden flex flex-col items-center justify-center pt-12 pb-6 px-6">
