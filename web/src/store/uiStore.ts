...
interface UIState {
  ...
  pendingCallKitCallId: string | null
  ...
  setPendingCallKitCallId: (id: string | null) => void
}
...
export const useUIStore = create<UIState>((set) => ({
  ...
  setPendingCallKitCallId: (id) => set({ pendingCallKitCallId: id }),
}))
